...
(function () {
  var COMMON = {
    zh: {
      ...
      foot_about:"吉隆坡的SEO与外链机构。我们让您的网站登上谷歌首页——覆盖韩国、日本与东南亚。", foot_svc:"服务", foot_markets:"市场", foot_company:"公司", foot_rights:"版权所有。"
    },
    ja: {
      ...
      foot_about:"クアラルンプールのSEO＆被リンク エージェンシー。あなたのサイトをGoogleの1ページ目へ — 韓国・日本・東南アジアで。", foot_svc:"サービス", foot_markets:"市場", foot_company:"会社", foot_rights:"無断転載を禁じます。"
    },
    th: {
      ...
      foot_about:"เอเจนซี SEO และลิงก์ย้อนกลับแห่งกัวลาลัมเปอร์ เรานำเว็บไซต์ของคุณขึ้นหน้าแรกของ Google — ครอบคลุมเกาหลี ญี่ปุ่น และเอเชียตะวันออกเฉียงใต้", foot_svc:"บริการ", foot_markets:"ตลาด", foot_company:"บริษัท", foot_rights:"สงวนลิขสิทธิ์"
    },
    ko: {
      ...
      foot_about:"쿠알라룸푸르의 SEO &amp; 백링크 에이전시. 귀사의 웹사이트를 구글 첫 페이지에 — 한국, 일본, 동남아시아 전역에서.", foot_svc:"서비스", foot_markets:"시장", foot_company:"회사", foot_rights:"모든 권리 보유."
    }
  };
